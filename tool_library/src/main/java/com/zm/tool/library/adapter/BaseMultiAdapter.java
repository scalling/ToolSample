package com.zm.tool.library.adapter;
...
import com.zm.tool.library.listener.IExpandable;
import com.zm.tool.library.listener.MultiItemEntity;

import java.util.ArrayList;
import java.util.Collection;
import java.util.List;

public abstract class BaseMultiAdapter<T extends MultiItemEntity> extends RecyclerView.Adapter<BaseRecyclerHolder> {
    ...
    public abstract void onBindItemHolder(BaseRecyclerHolder holder, int position);

    public void onBindItemHolder(BaseRecyclerHolder holder, int position, List<Object> payloads) {
