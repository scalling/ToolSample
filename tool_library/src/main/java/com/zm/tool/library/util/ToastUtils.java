...
public class ToastUtils {
    ...
    public static void showToast(Context sContext,String s) {
        if (toast == null) {
    ...
    public static void showToast(Context sContext,int resId) {
        showToast(sContext,sContext.getString(resId));
    }
}
